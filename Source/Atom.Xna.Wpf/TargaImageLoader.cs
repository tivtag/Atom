...
namespace Atom.Xna.Wpf
{
    ...
    public class TargaImage : IDisposable
    {
            ...
            : this()
        {
            ...
            if( System.IO.Path.GetExtension( fileName ).ToLower() == ".tga" )
            {
                ...
                {
                    throw new FileNotFoundException( @"Error loading file, could not find file '" + fileName + "' on disk.", fileName );
                }
            }
            else
            {
                throw new ArgumentException( @"Error loading file, file '" + fileName + "' must have an extension of '.tga'.", "fileName" );
            }
        }
    ...
    public sealed class TargaHeader
    {
        ...
        internal void SetImageIDLength( byte bImageIDLength )
        {
        ...
        internal void SetColorMapType( ColorMapType eColorMapType )
        {
        ...
        internal void SetImageType( ImageType eImageType )
        {
        ...
        internal void SetColorMapFirstEntryIndex( short sColorMapFirstEntryIndex )
        {
        ...
        internal void SetColorMapEntrySize( byte bColorMapEntrySize )
        {
        ...
        internal void SetXOrigin( short sXOrigin )
        {
        ...
        internal void SetWidth( short sWidth )
        {
            this.sWidth = sWidth;
        }
        ...
        internal void SetHeight( short sHeight )
        {
        ...
        internal void SetPixelDepth( byte bPixelDepth )
        {
        ...
        internal void SetVerticalTransferOrder( VerticalTransferOrder eVerticalTransferOrder )
        {
        ...
        internal void SetHorizontalTransferOrder( HorizontalTransferOrder eHorizontalTransferOrder )
        {
        ...
        internal void SetAttributeBits( byte bAttributeBits )
        {
        ...
        internal void SetImageIDValue( string strImageIDValue )
        {
    ...
    public class TargaFooter
    {
        ...
        internal void SetExtensionAreaOffset( int intExtensionAreaOffset )
        {
        ...
        internal void SetDeveloperDirectoryOffset( int intDeveloperDirectoryOffset )
        {
        ...
        internal void SetSignature( string strSignature )
        {
        ...
        internal void SetReservedCharacter( string strReservedCharacter )
        {
    ...
    /// </summary>
    public sealed class TargaExtensionArea
    {
        ...
        internal void SetExtensionSize( int intExtensionSize )
        {
        ...
        internal void SetAuthorComments( string strAuthorComments )
        {
        ...
        internal void SetDateTimeStamp( DateTime dtDateTimeStamp )
        {
        ...
        internal void SetJobName( string strJobName )
        {
        ...
        internal void SetJobTime( TimeSpan dtJobTime )
        {
        ...
        internal void SetSoftwareID( string strSoftwareID )
        {
        ...
        internal void SetSoftwareVersion( string strSoftwareVersion )
        {
        ...
        internal void SetKeyColor( Color cKeyColor )
        {
        ...
        internal void SetPixelAspectRatioNumerator( int intPixelAspectRatioNumerator )
        {
        ...
        internal void SetPixelAspectRatioDenominator( int intPixelAspectRatioDenominator )
        {
        ...
        internal void SetGammaNumerator( int intGammaNumerator )
        {
        ...
        internal void SetGammaDenominator( int intGammaDenominator )
        {
        ...
        internal void SetColorCorrectionOffset( int intColorCorrectionOffset )
        {
        ...
        internal void SetPostageStampOffset( int intPostageStampOffset )
        {
        ...
        internal void SetScanLineOffset( int intScanLineOffset )
        {
        ...
        internal void SetAttributesType( int intAttributesType )
        {
