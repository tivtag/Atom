...
//    {
//        /// <summary>
//        /// Gets or sets a value indicating whether this HighDynamicRange effect should 
//        /// expect rendered data use LogLuv encoding.
//        /// </summary>
//        /// <value>
//        /// The default value is false.
//        /// </value>
//        public bool UseLogLuvEncoding
//        {
//            get;
//            set;
//        }
...
//            this.thresholdEffect  = effectLoader.Load( "Threshold" );
//        }
...
//            this.ToneMap( sourceTexture, result, frameTime, this.UseLogLuvEncoding, true );
//        }
...
//        public void ToneMap( Texture2D source, RenderTarget2D result, float frameTime, bool encoded, bool preferHWScaling )
//        {
...
//            // Do the bloom first
//            IntermediateTexture threshold = this.GetIntermediateTexture( downscaleTarget.RenderTarget.Width, downscaleTarget.RenderTarget.Height, source.Format );
...
//            if( encoded )
//                this.thresholdEffect.CurrentTechnique = this.thresholdEffect.Techniques["ThresholdEncode"];
//            else
//                this.thresholdEffect.CurrentTechnique = this.thresholdEffect.Techniques["Threshold"];
...
//            this.ApplyPostProcess( sources2, threshold.RenderTarget, this.thresholdEffect );
...
//        {
//            return this.GetIntermediateTexture( width, height, format );
//        }
...
//        /// The format of the RenderTarget.
//        /// </param>
//        /// <param name="msQuality">
//        /// The multi sampling quality of the RenderTarget
//        /// </param>
//        /// <param name="msType">
//        /// The multi sampling type of the RenderTarget
//        /// </param>
//        /// <returns>
//        /// The suitable RenderTarget.
//        /// </returns>
//        private IntermediateTexture GetIntermediateTexture( int width, int height, SurfaceFormat format, MultiSampleType msType, int msQuality )
//        {
...
//                    msType == texture.RenderTarget.MultiSampleType &&
//                    msQuality == texture.RenderTarget.MultiSampleQuality )
//                {
//                    texture.InUse = true;
//                    return texture;
//                }
