...
namespace Atom.Xna.Effects.PostProcess
{
    ...
    /// </summary>
    public sealed class Bloom : ManagedDisposable, IPostProcessEffect
    {
        #region [ Enums ]
        ...
        /// </param>
        public Bloom( IEffectLoader effectLoader, IRenderTarget2DFactory renderTargetFactory, IGraphicsDeviceService deviceService )
        {
