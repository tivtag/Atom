// <copyright file="Vector3Converter.cs" company="federrot Software">
//     Copyright (c) federrot Software. All rights reserved.
// </copyright>
// <summary>
//     Defines the Atom.Math.Design.Vector3Converter class.
// </summary>
// <author>
//     Paul Ennemoser
// </author>
...
namespace Atom.Math.Design
{
    ...
    /// <summary>
    /// Provides a unified way of converting <see cref="Vector3"/> values to other types, 
    /// as well as for accessing standard values and subproperties.
    /// This class can't be inherited.
    /// </summary>
    public sealed class Vector3Converter : MathTypeConverter
    {
        /// <summary>
        ...
        public Vector3Converter()
        {
            ...
            this.PropertyDescriptions.Sort( new string[] { "X", "Y", "Z", "Length" } );
        }
        ...
        public override object ConvertFrom( ITypeDescriptorContext context, CultureInfo culture, object value )
        {
            ...
            if( str != null )
            {
                float[] array = StringUtilities.ConvertToValues<float>( context, culture, str, 3, "X; Y; Z" );
        ...
        public override object ConvertTo( ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType )
        {
            ...
            if( value is Vector3 )
            {
                ...
                {
                    return StringUtilities.ConvertFromValues<float>( context, culture, new float[] { vector.X, vector.Y, vector.Z } );
                }
                ...
                else if( destinationType == typeof( Point3 ) )
                {
        ...
        {
            if( destinationType == typeof( Point3 ) )
                return true;
