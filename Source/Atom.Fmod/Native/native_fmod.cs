...
namespace Atom.Fmod.Native
{
    ...
    */
    ...
    {
        internal const int number = 0x00044456;
#if WIN64
        internal const string dll    = "fmodex64";
#else
        internal const string dll = "fmodex";
#endif
    }
    ...
    */
    ...
    {
        internal float x;        /* X co-ordinate in 3D space. */
        internal float y;        /* Y co-ordinate in 3D space. */
        internal float z;        /* Z co-ordinate in 3D space. */
    }
    ...
    */
    ...
    {
        internal uint Data1;       /* Specifies the first 8 hexadecimal digits of the GUID */
        internal ushort Data2;       /* Specifies the first group of 4 hexadecimal digits.   */
        internal ushort Data3;       /* Specifies the second group of 4 hexadecimal digits.  */
        [MarshalAs( UnmanagedType.ByValArray, SizeConst = 8 )]
        internal byte[] Data4;       /* Array of 8 bytes. The first 2 bytes contain the third group of 4 hexadecimal digits. The remaining 6 bytes contain the final 12 hexadecimal digits. */
    }
    ...
    */
    ...
    {
        internal IntPtr handle;         /* [r] The file handle that was filled out in the open callback. */
        internal uint offset;         /* [r] Seek position, make sure you read from this file offset. */
        internal uint sizebytes;      /* [r] how many bytes requested for read. */
        internal int priority;       /* [r] 0 = low importance.  100 = extremely important (ie 'must read now or stuttering may occur') */

        internal IntPtr buffer;         /* [w] Buffer to read file data into. */
        internal uint bytesread;      /* [w] Fill this in before setting result code to tell FMOD how many bytes were read. */
        internal RESULT result;         /* [r/w] Result code, FMOD_OK tells the system it is ready to consume the data.  Set this last!  Default value = FMOD_ERR_NOTREADY. */

        internal IntPtr userdata;       /* [r] User data pointer. */
    }
    ...
    */
    internal enum SYSTEM_CALLBACKTYPE : int
    {
    ...
    */
    internal enum CHANNEL_CALLBACKTYPE : int
    {
    ...
    /* 
        FMOD Callbacks
    */
    internal delegate RESULT SYSTEM_CALLBACK( IntPtr systemraw, SYSTEM_CALLBACKTYPE type, IntPtr commanddata1, IntPtr commanddata2 );

    internal delegate RESULT CHANNEL_CALLBACK( IntPtr channelraw, CHANNEL_CALLBACKTYPE type, IntPtr commanddata1, IntPtr commanddata2 );

    internal delegate RESULT SOUND_NONBLOCKCALLBACK( IntPtr soundraw, RESULT result );
    internal delegate RESULT SOUND_PCMREADCALLBACK( IntPtr soundraw, IntPtr data, uint datalen );
    internal delegate RESULT SOUND_PCMSETPOSCALLBACK( IntPtr soundraw, int subsound, uint position, TIMEUNIT postype );

    internal delegate RESULT FILE_OPENCALLBACK( [MarshalAs( UnmanagedType.LPWStr )]string name, int unicode, ref uint filesize, ref IntPtr handle, ref IntPtr userdata );
    internal delegate RESULT FILE_CLOSECALLBACK( IntPtr handle, IntPtr userdata );
    internal delegate RESULT FILE_READCALLBACK( IntPtr handle, IntPtr buffer, uint sizebytes, ref uint bytesread, IntPtr userdata );
    internal delegate RESULT FILE_SEEKCALLBACK( IntPtr handle, int pos, IntPtr userdata );
    internal delegate RESULT FILE_ASYNCREADCALLBACK( IntPtr handle, IntPtr info, IntPtr userdata );
    internal delegate RESULT FILE_ASYNCCANCELCALLBACK( IntPtr handle, IntPtr userdata );

    internal delegate float CB_3D_ROLLOFFCALLBACK( IntPtr channelraw, float distance );
    ...
    */
    ...
    internal class DELAYTYPE_UTILITY
    {
    ...
    */
    ...
    internal struct TAG
    {
        internal TAGTYPE type;         /* [out] The type of this tag. */
        internal TAGDATATYPE datatype;     /* [out] The type of data that this tag contains */
        internal IntPtr namePtr;      /* [out] The name of this tag i.e. "TITLE", "ARTIST" etc. */
        internal IntPtr data;         /* [out] Pointer to the tag data - its format is determined by the datatype member */
        internal uint datalen;      /* [out] Length of the data contained in this tag */
        internal bool updated;      /* [out] True if this tag has been updated since last being accessed with Sound::getTag */
    ...
    */
    [StructLayout( LayoutKind.Sequential )]
    internal struct CDTOC
    {
        internal int numtracks;                  /* [out] The number of tracks on the CD */
        [MarshalAs( UnmanagedType.ByValArray, SizeConst = 100 )]
        internal int[] min;                   /* [out] The start offset of each track in minutes */
        [MarshalAs( UnmanagedType.ByValArray, SizeConst = 100 )]
        internal int[] sec;                   /* [out] The start offset of each track in seconds */
        [MarshalAs( UnmanagedType.ByValArray, SizeConst = 100 )]
        internal int[] frame;                 /* [out] The start offset of each track in frames */
    }
    ...
    */
    ...
    {
        internal int cbsize;                 /* [in] Size of this structure.  This is used so the structure can be expanded in the future and still work on older versions of FMOD Ex. */
        internal uint length;                 /* [in] Optional. Specify 0 to ignore. Size in bytes of file to load, or sound to create (in this case only if FMOD_OPENUSER is used).  Required if loading from memory.  If 0 is specified, then it will use the size of the file (unless loading from memory then an error will be returned). */
        internal uint fileoffset;             /* [in] Optional. Specify 0 to ignore. Offset from start of the file to start loading from.  This is useful for loading files from inside big data files. */
        internal int numchannels;            /* [in] Optional. Specify 0 to ignore. Number of channels in a sound specified only if OPENUSER is used. */
        internal int defaultfrequency;       /* [in] Optional. Specify 0 to ignore. Default frequency of sound in a sound specified only if OPENUSER is used.  Other formats use the frequency determined by the file format. */
        internal SOUND_FORMAT format;                 /* [in] Optional. Specify 0 or SOUND_FORMAT_NONE to ignore. Format of the sound specified only if OPENUSER is used.  Other formats use the format determined by the file format.   */
        internal uint decodebuffersize;       /* [in] Optional. Specify 0 to ignore. For streams.  This determines the size of the double buffer (in PCM samples) that a stream uses.  Use this for user created streams if you want to determine the size of the callback buffer passed to you.  Specify 0 to use FMOD's default size which is currently equivalent to 400ms of the sound format created/loaded. */
        internal int initialsubsound;        /* [in] Optional. Specify 0 to ignore. In a multi-sample file format such as .FSB/.DLS/.SF2, specify the initial subsound to seek to, only if CREATESTREAM is used. */
        internal int numsubsounds;           /* [in] Optional. Specify 0 to ignore or have no subsounds.  In a user created multi-sample sound, specify the number of subsounds within the sound that are accessable with Sound::getSubSound / SoundGetSubSound. */
        internal IntPtr inclusionlist;          /* [in] Optional. Specify 0 to ignore. In a multi-sample format such as .FSB/.DLS/.SF2 it may be desirable to specify only a subset of sounds to be loaded out of the whole file.  This is an array of subsound indicies to load into memory when created. */
        internal int inclusionlistnum;       /* [in] Optional. Specify 0 to ignore. This is the number of integers contained within the */
        internal SOUND_PCMREADCALLBACK pcmreadcallback;        /* [in] Optional. Specify 0 to ignore. Callback to 'piggyback' on FMOD's read functions and accept or even write PCM data while FMOD is opening the sound.  Used for user sounds created with OPENUSER or for capturing decoded data as FMOD reads it. */
        internal SOUND_PCMSETPOSCALLBACK pcmsetposcallback;      /* [in] Optional. Specify 0 to ignore. Callback for when the user calls a seeking function such as Channel::setPosition within a multi-sample sound, and for when it is opened.*/
        internal SOUND_NONBLOCKCALLBACK nonblockcallback;       /* [in] Optional. Specify 0 to ignore. Callback for successful completion, or error while loading a sound that used the FMOD_NONBLOCKING flag.*/
        internal string dlsname;                /* [in] Optional. Specify 0 to ignore. Filename for a DLS or SF2 sample set when loading a MIDI file.   If not specified, on windows it will attempt to open /windows/system32/drivers/gm.dls, otherwise the MIDI will fail to open.  */
        internal string encryptionkey;          /* [in] Optional. Specify 0 to ignore. Key for encrypted FSB file.  Without this key an encrypted FSB file will not load. */
        internal int maxpolyphony;           /* [in] Optional. Specify 0 to ingore. For sequenced formats with dynamic channel allocation such as .MID and .IT, this specifies the maximum voice count allowed while playing.  .IT defaults to 64.  .MID defaults to 32. */
        internal IntPtr userdata;               /* [in] Optional. Specify 0 to ignore. This is user data to be attached to the sound during creation.  Access via Sound::getUserData. */
        internal SOUND_TYPE suggestedsoundtype;     /* [in] Optional. Specify 0 or FMOD_SOUND_TYPE_UNKNOWN to ignore.  Instead of scanning all codec types, use this to speed up loading by making it jump straight to this codec. */
        internal FILE_OPENCALLBACK useropen;               /* [in] Optional. Specify 0 to ignore. Callback for opening this file. */
        internal FILE_CLOSECALLBACK userclose;              /* [in] Optional. Specify 0 to ignore. Callback for closing this file. */
        internal FILE_READCALLBACK userread;               /* [in] Optional. Specify 0 to ignore. Callback for reading from this file. */
        internal FILE_SEEKCALLBACK userseek;               /* [in] Optional. Specify 0 to ignore. Callback for seeking within this file. */
        internal FILE_ASYNCREADCALLBACK userasyncread;          /* [in] Optional. Specify 0 to ignore. Callback for asyncronously reading from this file. */
        internal FILE_ASYNCCANCELCALLBACK userasynccancel;        /* [in] Optional. Specify 0 to ignore. Callback for cancelling an asyncronous read. */
        internal SPEAKERMAPTYPE speakermap;             /* [in] Optional. Specify 0 to ignore. Use this to differ the way fmod maps multichannel sounds to speakers.  See FMOD_SPEAKERMAPTYPE for more. */
        internal IntPtr initialsoundgroup;      /* [in] Optional. Specify 0 to ignore. Specify a sound group if required, to put sound in as it is created. */
        internal uint initialseekposition;    /* [in] Optional. Specify 0 to ignore. For streams. Specify an initial position to seek the stream to. */
        internal TIMEUNIT initialseekpostype;     /* [in] Optional. Specify 0 to ignore. For streams. Specify the time unit for the position set in initialseekposition. */
        internal int ignoresetfilesystem;    /* [in] Optional. Specify 0 to ignore. Set to 1 to use fmod's built in file system. Ignores setFileSystem callbacks and also FMOD_CREATESOUNEXINFO file callbacks.  Useful for specific cases where you don't want to use your own file system but want to use fmod's file system (ie net streaming). */
        internal int cddaforceaspi;          /* [in] Optional. Specify 0 to ignore. For CDDA sounds only - if non-zero use ASPI instead of NTSCSI to access the specified CD/DVD device. */
        internal uint audioqueuepolicy;       /* [in] Optional. Specify 0 or FMOD_AUDIOQUEUE_CODECPOLICY_DEFAULT to ignore. Policy used to determine whether hardware or software is used for decoding, see FMOD_AUDIOQUEUE_CODECPOLICY for options (iOS >= 3.0 required, otherwise only hardware is available) */
        internal uint minmidigranularity;     /* [in] Optional. Specify 0 to ignore. Allows you to set a minimum desired MIDI mixer granularity. Values smaller than 512 give greater than default accuracy at the cost of more CPU and vise versa. Specify 0 for default (512 samples). */
        internal int nonblockthreadid;       /* [in] Optional. Specify 0 to ignore. Specifies a thread index to execute non blocking load on.  Allows for up to 5 threads to be used for loading at once.  This is to avoid one load blocking another.  Maximum value = 4. */
    }
    ...
    */
    ...
    {                                   /*          MIN     MAX    DEFAULT   DESCRIPTION */
        internal int Instance;          /* [in]     0     , 3     , 0      , EAX4 only. Environment Instance. 3 seperate reverbs simultaneously are possible. This specifies which one to set. (win32 only) */
        internal int Environment;       /* [in/out] -1    , 25    , -1     , sets all listener properties (win32/ps2) */
        internal float EnvDiffusion;      /* [in/out] 0.0   , 1.0   , 1.0    , environment diffusion (win32/xbox) */
        internal int Room;              /* [in/out] -10000, 0     , -1000  , room effect level (at mid frequencies) (win32/xbox) */
        internal int RoomHF;            /* [in/out] -10000, 0     , -100   , relative room effect level at high frequencies (win32/xbox) */
        internal int RoomLF;            /* [in/out] -10000, 0     , 0      , relative room effect level at low frequencies (win32 only) */
        internal float DecayTime;         /* [in/out] 0.1   , 20.0  , 1.49   , reverberation decay time at mid frequencies (win32/xbox) */
        internal float DecayHFRatio;      /* [in/out] 0.1   , 2.0   , 0.83   , high-frequency to mid-frequency decay time ratio (win32/xbox) */
        internal float DecayLFRatio;      /* [in/out] 0.1   , 2.0   , 1.0    , low-frequency to mid-frequency decay time ratio (win32 only) */
        internal int Reflections;       /* [in/out] -10000, 1000  , -2602  , early reflections level relative to room effect (win32/xbox) */
        internal float ReflectionsDelay;  /* [in/out] 0.0   , 0.3   , 0.007  , initial reflection delay time (win32/xbox) */
        internal int Reverb;            /* [in/out] -10000, 2000  , 200    , late reverberation level relative to room effect (win32/xbox) */
        internal float ReverbDelay;       /* [in/out] 0.0   , 0.1   , 0.011  , late reverberation delay time relative to initial reflection (win32/xbox) */
        internal float ModulationTime;    /* [in/out] 0.04  , 4.0   , 0.25   , modulation time (win32 only) */
        internal float ModulationDepth;   /* [in/out] 0.0   , 1.0   , 0.0    , modulation depth (win32 only) */
        internal float HFReference;       /* [in/out] 1000.0, 20000 , 5000.0 , reference high frequency (hz) (win32/xbox) */
        internal float LFReference;       /* [in/out] 20.0  , 1000.0, 250.0  , reference low frequency (hz) (win32 only) */
        internal float Diffusion;         /* [in/out] 0.0   , 100.0 , 100.0  , Value that controls the echo density in the late reverberation decay. (xbox only) */
        internal float Density;           /* [in/out] 0.0   , 100.0 , 100.0  , Value that controls the modal density in the late reverberation decay (xbox only) */
        internal uint Flags;             /* [in/out] REVERB_FLAGS - modifies the behavior of above properties (win32/ps2) */

        #region wrapperinternal
        internal REVERB_PROPERTIES( int instance, int environment, float envDiffusion, int room, int roomHF, int roomLF,
    ...
    */
    [StructLayout( LayoutKind.Sequential )]
    internal struct REVERB_FLAGS
    {
        internal const uint HIGHQUALITYREVERB = 0x00000400; /* Wii. Use high quality reverb */
        internal const uint HIGHQUALITYDPL2REVERB = 0x00000800; /* Wii. Use high quality DPL2 reverb */
    ...
    */
    class PRESET
    {
        ...
        internal REVERB_PROPERTIES OFF()
        ...
        internal REVERB_PROPERTIES GENERIC()
        ...
        internal REVERB_PROPERTIES PADDEDCELL()
        ...
        internal REVERB_PROPERTIES ROOM()
        ...
        internal REVERB_PROPERTIES BATHROOM()
        ...
        internal REVERB_PROPERTIES LIVINGROOM()
        ...
        internal REVERB_PROPERTIES STONEROOM()
        ...
        internal REVERB_PROPERTIES AUDITORIUM()
        ...
        internal REVERB_PROPERTIES CONCERTHALL()
        ...
        internal REVERB_PROPERTIES CAVE()
        ...
        internal REVERB_PROPERTIES ARENA()
        ...
        internal REVERB_PROPERTIES HANGAR()
        ...
        internal REVERB_PROPERTIES CARPETTEDHALLWAY()
        ...
        internal REVERB_PROPERTIES HALLWAY()
        ...
        internal REVERB_PROPERTIES STONECORRIDOR()
        ...
        internal REVERB_PROPERTIES ALLEY()
        ...
        internal REVERB_PROPERTIES FOREST()
        ...
        internal REVERB_PROPERTIES CITY()
        ...
        internal REVERB_PROPERTIES MOUNTAINS()
        ...
        internal REVERB_PROPERTIES QUARRY()
        ...
        internal REVERB_PROPERTIES PLAIN()
        ...
        internal REVERB_PROPERTIES PARKINGLOT()
        ...
        internal REVERB_PROPERTIES SEWERPIPE()
        ...
        internal REVERB_PROPERTIES UNDERWATER()
    ...
    */
    [StructLayout( LayoutKind.Sequential )]
    internal struct REVERB_CHANNELPROPERTIES
    {                                          /*          MIN     MAX    DEFAULT  DESCRIPTION */
        internal int Direct;               /* [in/out] -10000, 1000,  0,       direct path level (at low and mid frequencies) (win32/xbox) */
        internal int Room;                 /* [in/out] -10000, 1000,  0,       room effect level (at low and mid frequencies) (win32/xbox) */
        internal uint Flags;                /* [in/out] REVERB_CHANNELFLAGS - modifies the behavior of properties (win32) */
        internal IntPtr ConnectionPoint;      /* [in/out] See remarks.            DSP network location to connect reverb for this channel.    (SUPPORTED:SFX only).*/
    }
    ...
    */
    [StructLayout( LayoutKind.Sequential )]
    internal struct REVERB_CHANNELFLAGS
    {
        internal const uint INSTANCE0 = 0x00000010; /* SFX/Wii. Specify channel to target reverb instance 0.  Default target. */
        internal const uint INSTANCE1 = 0x00000020; /* SFX/Wii. Specify channel to target reverb instance 1. */
        internal const uint INSTANCE2 = 0x00000040; /* SFX/Wii. Specify channel to target reverb instance 2. */
        internal const uint INSTANCE3 = 0x00000080; /* SFX. Specify channel to target reverb instance 3. */
        internal const uint DEFAULT = INSTANCE0;
    }
    ...
    */
    ...
    {
        internal int cbsize;                      /* Size of structure.  Use sizeof(FMOD_ADVANCEDSETTINGS) */
        internal int maxMPEGcodecs;               /* For use with FMOD_CREATECOMPRESSEDSAMPLE only.  Mpeg  codecs consume 48,696 per instance and this number will determine how many mpeg channels can be played simultaneously.  Default = 16. */
        internal int maxADPCMcodecs;              /* For use with FMOD_CREATECOMPRESSEDSAMPLE only.  ADPCM codecs consume 1k per instance and this number will determine how many ADPCM channels can be played simultaneously.  Default = 32. */
        internal int maxXMAcodecs;                /* For use with FMOD_CREATECOMPRESSEDSAMPLE only.  XMA   codecs consume 8k per instance and this number will determine how many XMA channels can be played simultaneously.  Default = 32.  */
        internal int maxCELTcodecs;               /* [in/out] Optional. Specify 0 to ignore. For use with FMOD_CREATECOMPRESSEDSAMPLE only.  CELT  codecs consume 11,500 bytes per instance and this number will determine how many CELT channels can be played simultaneously. Default = 16 */
        internal int maxVORBIScodecs;             /* [in/out] Optional. Specify 0 to ignore. For use with FMOD_CREATECOMPRESSEDSAMPLE only.  Vorbis codecs consume 12,000 bytes per instance and this number will determine how many Vorbis channels can be played simultaneously. Default = 32. */
        internal int maxAT9Codecs;                /* [r/w] Optional. Specify 0 to ignore. For use with FMOD_CREATECOMPRESSEDSAMPLE only.  AT9 codecs consume  8,720 bytes per instance and this number will determine how many AT9 channels can be played simultaneously. Default = 32. */
        internal int maxPCMcodecs;                /* [in/out] Optional. Specify 0 to ignore. For use with PS3 only.                          PCM   codecs consume 12,672 bytes per instance and this number will determine how many streams and PCM voices can be played simultaneously. Default = 16 */
        internal int ASIONumChannels;             /* [in/out] */
        internal IntPtr ASIOChannelList;             /* [in/out] */
        internal IntPtr ASIOSpeakerList;             /* [in/out] Optional. Specify 0 to ignore. Pointer to a list of speakers that the ASIO channels map to.  This can be called after System::init to remap ASIO output. */
        internal int max3DReverbDSPs;             /* [in/out] The max number of 3d reverb DSP's in the system. */
        internal float HRTFMinAngle;                /* [in/out] For use with FMOD_INIT_HRTF_LOWPASS.  The angle (0-360) of a 3D sound from the listener's forward vector at which the HRTF function begins to have an effect.  Default = 180.0. */
        internal float HRTFMaxAngle;                /* [in/out] For use with FMOD_INIT_HRTF_LOWPASS.  The angle (0-360) of a 3D sound from the listener's forward vector at which the HRTF function begins to have maximum effect.  Default = 360.0.  */
        internal float HRTFFreq;                    /* [in/out] For use with FMOD_INIT_HRTF_LOWPASS.  The cutoff frequency of the HRTF's lowpass filter function when at maximum effect. (i.e. at HRTFMaxAngle).  Default = 4000.0. */
        internal float vol0virtualvol;              /* [in/out] For use with FMOD_INIT_VOL0_BECOMES_VIRTUAL.  If this flag is used, and the volume is 0.0, then the sound will become virtual.  Use this value to raise the threshold to a different point where a sound goes virtual. */
        internal int eventqueuesize;              /* [in/out] Optional. Specify 0 to ignore. For use with FMOD Event system only.  Specifies the number of slots available for simultaneous non blocking loads.  Default = 32. */
        internal uint defaultDecodeBufferSize;     /* [in/out] Optional. Specify 0 to ignore. For streams. This determines the default size of the double buffer (in milliseconds) that a stream uses.  Default = 400ms */
        internal string debugLogFilename;            /* [in/out] Optional. Specify 0 to ignore. Gives fmod's logging system a path/filename.  Normally the log is placed in the same directory as the executable and called fmod.log. When using System::getAdvancedSettings, provide at least 256 bytes of memory to copy into. */
        internal ushort profileport;                 /* [in/out] Optional. Specify 0 to ignore. For use with FMOD_INIT_ENABLE_PROFILE.  Specify the port to listen on for connections by the profiler application. */
        internal uint geometryMaxFadeTime;         /* [in/out] Optional. Specify 0 to ignore. The maximum time in miliseconds it takes for a channel to fade to the new level when its occlusion changes. */
        internal uint maxSpectrumWaveDataBuffers;  /* [in/out] Optional. Specify 0 to ignore. The maximum number of buffers for use with getWaveData/getSpectrum. */
        internal uint musicSystemCacheDelay;       /* [in/out] Optional. Specify 0 to ignore. The delay the music system should allow for loading a sample from disk (in milliseconds). Default = 400 ms. */
        internal float distanceFilterCenterFreq;    /* [in/out] Optional. Specify 0 to ignore. For use with FMOD_INIT_DISTANCE_FILTERING.  The default center frequency in Hz for the distance filtering effect. Default = 1500.0. */
        internal uint stackSizeStream;             /* [in/out] Optional. Specify 0 to ignore. Specify the stack size for the FMOD Stream thread in bytes.  Useful for custom codecs that use excess stack.  Default 49,152 (48kb) */
        internal uint stackSizeNonBlocking;        /* [in/out] Optional. Specify 0 to ignore. Specify the stack size for the FMOD_NONBLOCKING loading thread.  Useful for custom codecs that use excess stack.  Default 65,536 (64kb) */
        internal uint stackSizeMixer;              /* [in/out] Optional. Specify 0 to ignore. Specify the stack size for the FMOD mixer thread.  Useful for custom dsps that use excess stack.  Default 49,152 (48kb) */
    }
    ...
    */
    ...
    {
        internal static RESULT System_Create( ref System system )
        {
#if WIN64
            if (IntPtr.Size != 8)
            {
    ...
    {
        internal static RESULT GetStats( ref int currentalloced, ref int maxalloced )
        {
            return FMOD_Memory_GetStats( ref currentalloced, ref maxalloced, 1 );
        }

        internal static RESULT GetStats( ref int currentalloced, ref int maxalloced, bool blocking )
        {
    ...
    */
    internal class System
    {
        ...
        // Pre-init functions.
        internal RESULT setOutput( OUTPUTTYPE output )
        {
            return FMOD_System_SetOutput( systemraw, output );
        }
        internal RESULT getOutput( ref OUTPUTTYPE output )
        {
            return FMOD_System_GetOutput( systemraw, ref output );
        }
        internal RESULT getNumDrivers( ref int numdrivers )
        {
            return FMOD_System_GetNumDrivers( systemraw, ref numdrivers );
        }
        internal RESULT getDriverInfo( int id, [MarshalAs( UnmanagedType.LPWStr )]StringBuilder name, int namelen, ref GUID guid )
        {
            //use multibyte version
            return FMOD_System_GetDriverInfoW( systemraw, id, name, namelen, ref guid );
        }
        internal RESULT getDriverCaps( int id, ref CAPS caps, ref int controlpaneloutputrate, ref SPEAKERMODE controlpanelspeakermode )
        {
            return FMOD_System_GetDriverCaps( systemraw, id, ref caps, ref controlpaneloutputrate, ref controlpanelspeakermode );
        }
        internal RESULT setDriver( int driver )
        {
            return FMOD_System_SetDriver( systemraw, driver );
        }
        internal RESULT getDriver( ref int driver )
        {
            return FMOD_System_GetDriver( systemraw, ref driver );
        }
        internal RESULT setHardwareChannels( int numhardwarechannels )
        {
            return FMOD_System_SetHardwareChannels( systemraw, numhardwarechannels );
        }
        internal RESULT setSoftwareChannels( int numsoftwarechannels )
        {
            return FMOD_System_SetSoftwareChannels( systemraw, numsoftwarechannels );
        }
        internal RESULT getSoftwareChannels( ref int numsoftwarechannels )
        {
            return FMOD_System_GetSoftwareChannels( systemraw, ref numsoftwarechannels );
        }
        internal RESULT setSoftwareFormat( int samplerate, SOUND_FORMAT format, int numoutputchannels, int maxinputchannels, DSP_RESAMPLER resamplemethod )
        {
            return FMOD_System_SetSoftwareFormat( systemraw, samplerate, format, numoutputchannels, maxinputchannels, resamplemethod );
        }
        internal RESULT getSoftwareFormat( ref int samplerate, ref SOUND_FORMAT format, ref int numoutputchannels, ref int maxinputchannels, ref DSP_RESAMPLER resamplemethod, ref int bits )
        {
        ...
        internal RESULT setDSPBufferSize( uint bufferlength, int numbuffers )
        {
            return FMOD_System_SetDSPBufferSize( systemraw, bufferlength, numbuffers );
        }
        internal RESULT getDSPBufferSize( ref uint bufferlength, ref int numbuffers )
        {
            return FMOD_System_GetDSPBufferSize( systemraw, ref bufferlength, ref numbuffers );
        }
        internal RESULT setFileSystem( FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek, FILE_ASYNCREADCALLBACK userasyncread, FILE_ASYNCCANCELCALLBACK userasynccancel, int blockalign )
        {
            return FMOD_System_SetFileSystem( systemraw, useropen, userclose, userread, userseek, userasyncread, userasynccancel, blockalign );
        }
        internal RESULT attachFileSystem( FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek )
        {
            return FMOD_System_AttachFileSystem( systemraw, useropen, userclose, userread, userseek );
        }
        internal RESULT setAdvancedSettings( ref ADVANCEDSETTINGS settings )
        {
            return FMOD_System_SetAdvancedSettings( systemraw, ref settings );
        }
        internal RESULT getAdvancedSettings( ref ADVANCEDSETTINGS settings )
        {
            return FMOD_System_GetAdvancedSettings( systemraw, ref settings );
        }
        internal RESULT setSpeakerMode( SPEAKERMODE speakermode )
        {
            return FMOD_System_SetSpeakerMode( systemraw, speakermode );
        }
        internal RESULT getSpeakerMode( ref SPEAKERMODE speakermode )
        {
            return FMOD_System_GetSpeakerMode( systemraw, ref speakermode );
        }
        internal RESULT setCallback( SYSTEM_CALLBACK callback )
        {
            return FMOD_System_SetCallback( systemraw, callback );
        }

        // Plug-in support
        internal RESULT setPluginPath( string path )
        {
            return FMOD_System_SetPluginPath( systemraw, path );
        }
        internal RESULT loadPlugin( string filename, ref uint handle, uint priority )
        {
            return FMOD_System_LoadPlugin( systemraw, filename, ref handle, priority );
        }
        internal RESULT unloadPlugin( uint handle )
        {
            return FMOD_System_UnloadPlugin( systemraw, handle );
        }
        internal RESULT getNumPlugins( PLUGINTYPE plugintype, ref int numplugins )
        {
            return FMOD_System_GetNumPlugins( systemraw, plugintype, ref numplugins );
        }
        internal RESULT getPluginHandle( PLUGINTYPE plugintype, int index, ref uint handle )
        {
            return FMOD_System_GetPluginHandle( systemraw, plugintype, index, ref handle );
        }
        internal RESULT getPluginInfo( uint handle, ref PLUGINTYPE plugintype, StringBuilder name, int namelen, ref uint version )
        {
            return FMOD_System_GetPluginInfo( systemraw, handle, ref plugintype, name, namelen, ref version );
        }

        internal RESULT setOutputByPlugin( uint handle )
        {
            return FMOD_System_SetOutputByPlugin( systemraw, handle );
        }
        internal RESULT getOutputByPlugin( ref uint handle )
        {
            return FMOD_System_GetOutputByPlugin( systemraw, ref handle );
        }
        internal RESULT createDSPByPlugin( uint handle, ref IntPtr dsp )
        {
            return FMOD_System_CreateDSPByPlugin( systemraw, handle, ref dsp );
        }
        internal RESULT createCodec( IntPtr description, uint priority )
        {
        ...
        // Init/Close 
        internal RESULT init( int maxchannels, INITFLAGS flags, IntPtr extradriverdata )
        {
        ...
        internal RESULT set3DSettings( float dopplerscale, float distancefactor, float rolloffscale )
        {
            return FMOD_System_Set3DSettings( systemraw, dopplerscale, distancefactor, rolloffscale );
        }
        internal RESULT get3DSettings( ref float dopplerscale, ref float distancefactor, ref float rolloffscale )
        {
            return FMOD_System_Get3DSettings( systemraw, ref dopplerscale, ref distancefactor, ref rolloffscale );
        }
        internal RESULT set3DNumListeners( int numlisteners )
        {
            return FMOD_System_Set3DNumListeners( systemraw, numlisteners );
        }
        internal RESULT get3DNumListeners( ref int numlisteners )
        {
            return FMOD_System_Get3DNumListeners( systemraw, ref numlisteners );
        }
        internal RESULT set3DListenerAttributes( int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up )
        {
            return FMOD_System_Set3DListenerAttributes( systemraw, listener, ref pos, ref vel, ref forward, ref up );
        }
        internal RESULT get3DListenerAttributes( int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up )
        {
            return FMOD_System_Get3DListenerAttributes( systemraw, listener, ref pos, ref vel, ref forward, ref up );
        }

        internal RESULT set3DRolloffCallback( CB_3D_ROLLOFFCALLBACK callback )
        {
            return FMOD_System_Set3DRolloffCallback( systemraw, callback );
        }
        internal RESULT set3DSpeakerPosition( SPEAKER speaker, float x, float y, bool active )
        {
            return FMOD_System_Set3DSpeakerPosition( systemraw, speaker, x, y, (active ? 1 : 0) );
        }
        internal RESULT get3DSpeakerPosition( SPEAKER speaker, ref float x, ref float y, ref bool active )
        {
            RESULT result;
        ...
        internal RESULT setStreamBufferSize( uint filebuffersize, TIMEUNIT filebuffersizetype )
        {
            return FMOD_System_SetStreamBufferSize( systemraw, filebuffersize, filebuffersizetype );
        }
        internal RESULT getStreamBufferSize( ref uint filebuffersize, ref TIMEUNIT filebuffersizetype )
        {
        ...
        internal RESULT getVersion( ref uint version )
        {
            return FMOD_System_GetVersion( systemraw, ref version );
        }
        internal RESULT getOutputHandle( ref IntPtr handle )
        {
            return FMOD_System_GetOutputHandle( systemraw, ref handle );
        }
        internal RESULT getChannelsPlaying( ref int channels )
        {
            return FMOD_System_GetChannelsPlaying( systemraw, ref channels );
        }
        internal RESULT getHardwareChannels( ref int numhardwarechannels )
        {
            return FMOD_System_GetHardwareChannels( systemraw, ref numhardwarechannels );
        }
        internal RESULT getCPUUsage( ref float dsp, ref float stream, ref float geometry, ref float update, ref float total )
        {
            return FMOD_System_GetCPUUsage( systemraw, ref dsp, ref stream, ref geometry, ref update, ref total );
        }
        internal RESULT getSoundRAM( ref int currentalloced, ref int maxalloced, ref int total )
        {
            return FMOD_System_GetSoundRAM( systemraw, ref currentalloced, ref maxalloced, ref total );
        }
        internal RESULT getNumCDROMDrives( ref int numdrives )
        {
            return FMOD_System_GetNumCDROMDrives( systemraw, ref numdrives );
        }
        internal RESULT getCDROMDriveName( int drive, StringBuilder drivename, int drivenamelen, StringBuilder scsiname, int scsinamelen, StringBuilder devicename, int devicenamelen )
        {
        ...
        internal RESULT getSpectrum( float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype )
        {
            return FMOD_System_GetSpectrum( systemraw, spectrumarray, numvalues, channeloffset, windowtype );
        }
        internal RESULT getWaveData( float[] wavearray, int numvalues, int channeloffset )
        {
        ...
        internal RESULT createSound( string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT createSound( byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT createSound( string name_or_data, MODE mode, ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT createStream( string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT createStream( byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT createStream( string name_or_data, MODE mode, ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT createDSP( ref DSP_DESCRIPTION description, ref DSP dsp )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT createDSPByType( DSP_TYPE type, ref DSP dsp )
        {
            RESULT result = RESULT.OK;
            IntPtr dspraw = new IntPtr();
            DSP dspnew = null;
        ...
        internal RESULT createChannelGroup( string name, ref ChannelGroup channelgroup )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT createSoundGroup( string name, ref SoundGroup soundgroup )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT createReverb( ref Reverb reverb )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT playSound( CHANNELINDEX channelid, Sound sound, bool paused, ref Channel channel )
        {
            RESULT result = RESULT.OK;
            IntPtr channelraw;
        ...
        internal RESULT playDSP( CHANNELINDEX channelid, DSP dsp, bool paused, ref Channel channel )
        {
            RESULT result = RESULT.OK;
            IntPtr channelraw;
            Channel channelnew = null;
        ...
        internal RESULT getChannel( int channelid, ref Channel channel )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT getMasterChannelGroup( ref ChannelGroup channelgroup )
        {
            RESULT result = RESULT.OK;
            IntPtr channelgroupraw = new IntPtr();
            ChannelGroup channelgroupnew = null;
        ...
        internal RESULT getMasterSoundGroup( ref SoundGroup soundgroup )
        {
            RESULT result = RESULT.OK;
            IntPtr soundgroupraw = new IntPtr();
            SoundGroup soundgroupnew = null;
        ...
        // Reverb api
        internal RESULT setReverbProperties( ref REVERB_PROPERTIES prop )
        {
            return FMOD_System_SetReverbProperties( systemraw, ref prop );
        }
        internal RESULT getReverbProperties( ref REVERB_PROPERTIES prop )
        {
            return FMOD_System_GetReverbProperties( systemraw, ref prop );
        }

        internal RESULT setReverbAmbientProperties( ref REVERB_PROPERTIES prop )
        {
            return FMOD_System_SetReverbAmbientProperties( systemraw, ref prop );
        }
        internal RESULT getReverbAmbientProperties( ref REVERB_PROPERTIES prop )
        {
            return FMOD_System_GetReverbAmbientProperties( systemraw, ref prop );
        }

        // System level DSP access.
        internal RESULT getDSPHead( ref DSP dsp )
        {
            RESULT result = RESULT.OK;
            IntPtr dspraw = new IntPtr();
            DSP dspnew = null;
        ...
        internal RESULT addDSP( DSP dsp, ref DSPConnection connection )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT lockDSP()
        {
            return FMOD_System_LockDSP( systemraw );
        }
        internal RESULT unlockDSP()
        {
            return FMOD_System_UnlockDSP( systemraw );
        }
        internal RESULT getDSPClock( ref uint hi, ref uint lo )
        {
        ...
        // Recording api
        internal RESULT getRecordNumDrivers( ref int numdrivers )
        {
            return FMOD_System_GetRecordNumDrivers( systemraw, ref numdrivers );
        }
        internal RESULT getRecordDriverInfo( int id, [MarshalAs( UnmanagedType.LPWStr )]StringBuilder name, int namelen, ref GUID guid )
        {
            //use multibyte version
            return FMOD_System_GetRecordDriverInfoW( systemraw, id, name, namelen, ref guid );
        }
        internal RESULT getRecordDriverCaps( int id, ref CAPS caps, ref int minfrequency, ref int maxfrequency )
        {
            return FMOD_System_GetRecordDriverCaps( systemraw, id, ref caps, ref minfrequency, ref maxfrequency );
        }
        internal RESULT getRecordPosition( int id, ref uint position )
        {
            return FMOD_System_GetRecordPosition( systemraw, id, ref position );
        }

        internal RESULT recordStart( int id, Sound sound, bool loop )
        {
            return FMOD_System_RecordStart( systemraw, id, sound.getRaw(), (loop ? 1 : 0) );
        }
        internal RESULT recordStop( int id )
        {
            return FMOD_System_RecordStop( systemraw, id );
        }
        internal RESULT isRecording( int id, ref bool recording )
        {
            RESULT result;
            int r = 0;
        ...
        // Geometry api 
        internal RESULT createGeometry( int maxpolygons, int maxvertices, ref Geometry geometry )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT setGeometrySettings( float maxworldsize )
        {
            return FMOD_System_SetGeometrySettings( systemraw, maxworldsize );
        }
        internal RESULT getGeometrySettings( ref float maxworldsize )
        {
            return FMOD_System_GetGeometrySettings( systemraw, ref maxworldsize );
        }
        internal RESULT loadGeometry( IntPtr data, int datasize, ref Geometry geometry )
        {
            RESULT result = RESULT.OK;
            IntPtr geometryraw = new IntPtr();
            Geometry geometrynew = null;
        ...
        internal RESULT getGeometryOcclusion( ref VECTOR listener, ref VECTOR source, ref float direct, ref float reverb )
        {
            return FMOD_System_GetGeometryOcclusion( systemraw, ref listener, ref source, ref direct, ref reverb );
        }

        // Network functions
        internal RESULT setNetworkProxy( string proxy )
        {
            return FMOD_System_SetNetworkProxy( systemraw, proxy );
        }
        internal RESULT getNetworkProxy( StringBuilder proxy, int proxylen )
        {
            return FMOD_System_GetNetworkProxy( systemraw, proxy, proxylen );
        }
        internal RESULT setNetworkTimeout( int timeout )
        {
            return FMOD_System_SetNetworkTimeout( systemraw, timeout );
        }
        internal RESULT getNetworkTimeout( ref int timeout )
        {
            return FMOD_System_GetNetworkTimeout( systemraw, ref timeout );
        }

        // Userdata set/get                         
        internal RESULT setUserData( IntPtr userdata )
        {
            return FMOD_System_SetUserData( systemraw, userdata );
        }
        internal RESULT getUserData( ref IntPtr userdata )
        {
            return FMOD_System_GetUserData( systemraw, ref userdata );
        }

        internal RESULT getMemoryInfo( uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details )
        {
        ...
        internal void setRaw( IntPtr system )
        {
    ...
    */
    internal class Sound
    {
        ...
        internal RESULT getSystemObject( ref System system )
        {
            RESULT result = RESULT.OK;
            IntPtr systemraw = new IntPtr();
            System systemnew = null;
        ...
        internal RESULT @lock( uint offset, uint length, ref IntPtr ptr1, ref IntPtr ptr2, ref uint len1, ref uint len2 )
        {
            return FMOD_Sound_Lock( soundraw, offset, length, ref ptr1, ref ptr2, ref len1, ref len2 );
        }
        internal RESULT unlock( IntPtr ptr1, IntPtr ptr2, uint len1, uint len2 )
        {
            return FMOD_Sound_Unlock( soundraw, ptr1, ptr2, len1, len2 );
        }
        internal RESULT setDefaults( float frequency, float volume, float pan, int priority )
        {
            return FMOD_Sound_SetDefaults( soundraw, frequency, volume, pan, priority );
        }
        internal RESULT getDefaults( ref float frequency, ref float volume, ref float pan, ref int priority )
        {
            return FMOD_Sound_GetDefaults( soundraw, ref frequency, ref volume, ref pan, ref priority );
        }
        internal RESULT setVariations( float frequencyvar, float volumevar, float panvar )
        {
            return FMOD_Sound_SetVariations( soundraw, frequencyvar, volumevar, panvar );
        }
        internal RESULT getVariations( ref float frequencyvar, ref float volumevar, ref float panvar )
        {
            return FMOD_Sound_GetVariations( soundraw, ref frequencyvar, ref volumevar, ref panvar );
        }
        internal RESULT set3DMinMaxDistance( float min, float max )
        {
            return FMOD_Sound_Set3DMinMaxDistance( soundraw, min, max );
        }
        internal RESULT get3DMinMaxDistance( ref float min, ref float max )
        {
            return FMOD_Sound_Get3DMinMaxDistance( soundraw, ref min, ref max );
        }
        internal RESULT set3DConeSettings( float insideconeangle, float outsideconeangle, float outsidevolume )
        {
            return FMOD_Sound_Set3DConeSettings( soundraw, insideconeangle, outsideconeangle, outsidevolume );
        }
        internal RESULT get3DConeSettings( ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume )
        {
            return FMOD_Sound_Get3DConeSettings( soundraw, ref insideconeangle, ref outsideconeangle, ref outsidevolume );
        }
        internal RESULT set3DCustomRolloff( ref VECTOR points, int numpoints )
        {
            return FMOD_Sound_Set3DCustomRolloff( soundraw, ref points, numpoints );
        }
        internal RESULT get3DCustomRolloff( ref IntPtr points, ref int numpoints )
        {
            return FMOD_Sound_Get3DCustomRolloff( soundraw, ref points, ref numpoints );
        }
        internal RESULT setSubSound( int index, Sound subsound )
        {
            IntPtr subsoundraw = subsound.getRaw();

            return FMOD_Sound_SetSubSound( soundraw, index, subsoundraw );
        }
        internal RESULT getSubSound( int index, ref Sound subsound )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT setSubSoundSentence( int[] subsoundlist, int numsubsounds )
        {
            return FMOD_Sound_SetSubSoundSentence( soundraw, subsoundlist, numsubsounds );
        }
        internal RESULT getName( StringBuilder name, int namelen )
        {
            return FMOD_Sound_GetName( soundraw, name, namelen );
        }
        internal RESULT getLength( ref uint length, TIMEUNIT lengthtype )
        {
            return FMOD_Sound_GetLength( soundraw, ref length, lengthtype );
        }
        internal RESULT getFormat( ref SOUND_TYPE type, ref SOUND_FORMAT format, ref int channels, ref int bits )
        {
            return FMOD_Sound_GetFormat( soundraw, ref type, ref format, ref channels, ref bits );
        }
        internal RESULT getNumSubSounds( ref int numsubsounds )
        {
            return FMOD_Sound_GetNumSubSounds( soundraw, ref numsubsounds );
        }
        internal RESULT getNumTags( ref int numtags, ref int numtagsupdated )
        {
            return FMOD_Sound_GetNumTags( soundraw, ref numtags, ref numtagsupdated );
        }
        internal RESULT getTag( string name, int index, ref TAG tag )
        {
            return FMOD_Sound_GetTag( soundraw, name, index, ref tag );
        }
        internal RESULT getOpenState( ref OPENSTATE openstate, ref uint percentbuffered, ref bool starving, ref bool diskbusy )
        {
            RESULT result;
            int s = 0;
            int b = 0;
        ...
        internal RESULT readData( IntPtr buffer, uint lenbytes, ref uint read )
        {
            return FMOD_Sound_ReadData( soundraw, buffer, lenbytes, ref read );
        }
        internal RESULT seekData( uint pcm )
        {
            return FMOD_Sound_SeekData( soundraw, pcm );
        }


        internal RESULT setSoundGroup( SoundGroup soundgroup )
        {
            return FMOD_Sound_SetSoundGroup( soundraw, soundgroup.getRaw() );
        }
        internal RESULT getSoundGroup( ref SoundGroup soundgroup )
        {
            RESULT result = RESULT.OK;
            IntPtr soundgroupraw = new IntPtr();
            SoundGroup soundgroupnew = null;
        ...
        internal RESULT getNumSyncPoints( ref int numsyncpoints )
        {
            return FMOD_Sound_GetNumSyncPoints( soundraw, ref numsyncpoints );
        }
        internal RESULT getSyncPoint( int index, ref IntPtr point )
        {
            return FMOD_Sound_GetSyncPoint( soundraw, index, ref point );
        }
        internal RESULT getSyncPointInfo( IntPtr point, StringBuilder name, int namelen, ref uint offset, TIMEUNIT offsettype )
        {
            return FMOD_Sound_GetSyncPointInfo( soundraw, point, name, namelen, ref offset, offsettype );
        }
        internal RESULT addSyncPoint( uint offset, TIMEUNIT offsettype, string name, ref IntPtr point )
        {
            return FMOD_Sound_AddSyncPoint( soundraw, offset, offsettype, name, ref point );
        }
        internal RESULT deleteSyncPoint( IntPtr point )
        {
            return FMOD_Sound_DeleteSyncPoint( soundraw, point );
        }


        internal RESULT setMode( MODE mode )
        {
            return FMOD_Sound_SetMode( soundraw, mode );
        }
        internal RESULT getMode( ref MODE mode )
        {
            return FMOD_Sound_GetMode( soundraw, ref mode );
        }
        internal RESULT setLoopCount( int loopcount )
        {
            return FMOD_Sound_SetLoopCount( soundraw, loopcount );
        }
        internal RESULT getLoopCount( ref int loopcount )
        {
            return FMOD_Sound_GetLoopCount( soundraw, ref loopcount );
        }
        internal RESULT setLoopPoints( uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype )
        {
            return FMOD_Sound_SetLoopPoints( soundraw, loopstart, loopstarttype, loopend, loopendtype );
        }
        internal RESULT getLoopPoints( ref uint loopstart, TIMEUNIT loopstarttype, ref uint loopend, TIMEUNIT loopendtype )
        {
            return FMOD_Sound_GetLoopPoints( soundraw, ref loopstart, loopstarttype, ref loopend, loopendtype );
        }

        internal RESULT getMusicNumChannels( ref int numchannels )
        {
            return FMOD_Sound_GetMusicNumChannels( soundraw, ref numchannels );
        }
        internal RESULT setMusicChannelVolume( int channel, float volume )
        {
            return FMOD_Sound_SetMusicChannelVolume( soundraw, channel, volume );
        }
        internal RESULT getMusicChannelVolume( int channel, ref float volume )
        {
            return FMOD_Sound_GetMusicChannelVolume( soundraw, channel, ref volume );
        }
        internal RESULT setMusicSpeed( float speed )
        {
            return FMOD_Sound_SetMusicSpeed( soundraw, speed );
        }
        internal RESULT getMusicSpeed( ref float speed )
        {
        ...
        internal void setRaw( IntPtr sound )
        {
            soundraw = new IntPtr();
            soundraw = sound;
        }
    ...
    */
    internal class Channel
    {
        ...
        internal RESULT stop()
        {
            return FMOD_Channel_Stop( channelraw );
        }
        internal RESULT setPaused( bool paused )
        {
            return FMOD_Channel_SetPaused( channelraw, (paused ? 1 : 0) );
        }
        internal RESULT getPaused( ref bool paused )
        {
            RESULT result;
            int p = 0;
        ...
        internal RESULT setVolume( float volume )
        {
            return FMOD_Channel_SetVolume( channelraw, volume );
        }
        internal RESULT getVolume( ref float volume )
        {
            return FMOD_Channel_GetVolume( channelraw, ref volume );
        }
        internal RESULT setFrequency( float frequency )
        {
            return FMOD_Channel_SetFrequency( channelraw, frequency );
        }
        internal RESULT getFrequency( ref float frequency )
        {
            return FMOD_Channel_GetFrequency( channelraw, ref frequency );
        }
        internal RESULT setPan( float pan )
        {
            return FMOD_Channel_SetPan( channelraw, pan );
        }
        internal RESULT getPan( ref float pan )
        {
            return FMOD_Channel_GetPan( channelraw, ref pan );
        }
        internal RESULT setDelay( DELAYTYPE delaytype, uint delayhi, uint delaylo )
        {
            return FMOD_Channel_SetDelay( channelraw, delaytype, delayhi, delaylo );
        }
        internal RESULT getDelay( DELAYTYPE delaytype, ref uint delayhi, ref uint delaylo )
        {
            return FMOD_Channel_GetDelay( channelraw, delaytype, ref delayhi, ref delaylo );
        }
        internal RESULT setSpeakerMix( float frontleft, float frontright, float center, float lfe, float backleft, float backright, float sideleft, float sideright )
        {
            return FMOD_Channel_SetSpeakerMix( channelraw, frontleft, frontright, center, lfe, backleft, backright, sideleft, sideright );
        }
        internal RESULT getSpeakerMix( ref float frontleft, ref float frontright, ref float center, ref float lfe, ref float backleft, ref float backright, ref float sideleft, ref float sideright )
        {
        ...
        internal RESULT setSpeakerLevels( SPEAKER speaker, float[] levels, int numlevels )
        {
            return FMOD_Channel_SetSpeakerLevels( channelraw, speaker, levels, numlevels );
        }
        internal RESULT getSpeakerLevels( SPEAKER speaker, float[] levels, int numlevels )
        {
            return FMOD_Channel_GetSpeakerLevels( channelraw, speaker, levels, numlevels );
        }
        internal RESULT setInputChannelMix( float[] levels, int numlevels )
        {
            return FMOD_Channel_SetInputChannelMix( channelraw, levels, numlevels );
        }
        internal RESULT getInputChannelMix( float[] levels, int numlevels )
        {
            return FMOD_Channel_GetInputChannelMix( channelraw, levels, numlevels );
        }
        internal RESULT setMute( bool mute )
        {
            return FMOD_Channel_SetMute( channelraw, (mute ? 1 : 0) );
        }
        internal RESULT getMute( ref bool mute )
        {
            RESULT result;
            int m = 0;
        ...
        internal RESULT setPriority( int priority )
        {
            return FMOD_Channel_SetPriority( channelraw, priority );
        }
        internal RESULT getPriority( ref int priority )
        {
            return FMOD_Channel_GetPriority( channelraw, ref priority );
        }
        internal RESULT setPosition( uint position, TIMEUNIT postype )
        {
            return FMOD_Channel_SetPosition( channelraw, position, postype );
        }
        internal RESULT getPosition( ref uint position, TIMEUNIT postype )
        {
            return FMOD_Channel_GetPosition( channelraw, ref position, postype );
        }

        internal RESULT setLowPassGain( float gain )
        {
            return FMOD_Channel_SetLowPassGain( channelraw, gain );
        }
        internal RESULT getLowPassGain( ref float gain )
        {
            return FMOD_Channel_GetLowPassGain( channelraw, ref gain );
        }

        internal RESULT setReverbProperties( ref REVERB_CHANNELPROPERTIES prop )
        {
            return FMOD_Channel_SetReverbProperties( channelraw, ref prop );
        }
        internal RESULT getReverbProperties( ref REVERB_CHANNELPROPERTIES prop )
        {
            return FMOD_Channel_GetReverbProperties( channelraw, ref prop );
        }
        internal RESULT setChannelGroup( ChannelGroup channelgroup )
        {
            return FMOD_Channel_SetChannelGroup( channelraw, channelgroup.getRaw() );
        }
        internal RESULT getChannelGroup( ref ChannelGroup channelgroup )
        {
            RESULT result = RESULT.OK;
            IntPtr channelgroupraw = new IntPtr();
            ChannelGroup channelgroupnew = null;
        ...
        internal RESULT setCallback( CHANNEL_CALLBACK callback )
        {
            return FMOD_Channel_SetCallback( channelraw, callback );
        }


        internal RESULT set3DAttributes( ref VECTOR pos, ref VECTOR vel )
        {
            return FMOD_Channel_Set3DAttributes( channelraw, ref pos, ref vel );
        }
        internal RESULT get3DAttributes( ref VECTOR pos, ref VECTOR vel )
        {
            return FMOD_Channel_Get3DAttributes( channelraw, ref pos, ref vel );
        }
        internal RESULT set3DMinMaxDistance( float mindistance, float maxdistance )
        {
            return FMOD_Channel_Set3DMinMaxDistance( channelraw, mindistance, maxdistance );
        }
        internal RESULT get3DMinMaxDistance( ref float mindistance, ref float maxdistance )
        {
        ...
        internal RESULT set3DConeOrientation( ref VECTOR orientation )
        {
            return FMOD_Channel_Set3DConeOrientation( channelraw, ref orientation );
        }
        internal RESULT get3DConeOrientation( ref VECTOR orientation )
        {
        ...
        internal RESULT isVirtual( ref bool isvirtual )
        {
            RESULT result;
            int v = 0;
        ...
        internal RESULT getAudibility( ref float audibility )
        {
            return FMOD_Channel_GetAudibility( channelraw, ref audibility );
        }
        internal RESULT getCurrentSound( ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT getIndex( ref int index )
        {
        ...
        internal void setRaw( IntPtr channel )
        {
            channelraw = new IntPtr();
    ...
    */
    internal class ChannelGroup
    {
        ...
        internal RESULT setPitch( float pitch )
        {
            return FMOD_ChannelGroup_SetPitch( channelgroupraw, pitch );
        }
        internal RESULT getPitch( ref float pitch )
        {
        ...
        internal RESULT overrideVolume( float volume )
        {
            return FMOD_ChannelGroup_OverrideVolume( channelgroupraw, volume );
        }
        internal RESULT overrideFrequency( float frequency )
        {
            return FMOD_ChannelGroup_OverrideFrequency( channelgroupraw, frequency );
        }
        internal RESULT overridePan( float pan )
        {
            return FMOD_ChannelGroup_OverridePan( channelgroupraw, pan );
        }
        internal RESULT overrideReverbProperties( ref REVERB_CHANNELPROPERTIES prop )
        {
            return FMOD_ChannelGroup_OverrideReverbProperties( channelgroupraw, ref prop );
        }
        internal RESULT override3DAttributes( ref VECTOR pos, ref VECTOR vel )
        {
            return FMOD_ChannelGroup_Override3DAttributes( channelgroupraw, ref pos, ref vel );
        }
        internal RESULT overrideSpeakerMix( float frontleft, float frontright, float center, float lfe, float backleft, float backright, float sideleft, float sideright )
        {
        ...
        internal RESULT addGroup( ChannelGroup group )
        {
            return FMOD_ChannelGroup_AddGroup( channelgroupraw, group.getRaw() );
        }
        internal RESULT getNumGroups( ref int numgroups )
        {
            return FMOD_ChannelGroup_GetNumGroups( channelgroupraw, ref numgroups );
        }
        internal RESULT getGroup( int index, ref ChannelGroup group )
        {
            RESULT result = RESULT.OK;
            IntPtr channelraw = new IntPtr();
        ...
        internal RESULT getParentGroup( ref ChannelGroup group )
        {
            RESULT result = RESULT.OK;
            IntPtr channelraw = new IntPtr();
            ChannelGroup channelnew = null;
        ...
        internal RESULT getNumChannels( ref int numchannels )
        {
            return FMOD_ChannelGroup_GetNumChannels( channelgroupraw, ref numchannels );
        }
        internal RESULT getChannel( int index, ref Channel channel )
        {
            RESULT result = RESULT.OK;
            IntPtr channelraw = new IntPtr();
            Channel channelnew = null;
        ...
        internal void setRaw( IntPtr channelgroup )
        {
    ...
    */
    internal class SoundGroup
    {
        ...
        internal RESULT getNumSounds( ref int numsounds )
        {
            return FMOD_SoundGroup_GetNumSounds( soundgroupraw, ref numsounds );
        }
        internal RESULT getSound( int index, ref Sound sound )
        {
            RESULT result = RESULT.OK;
            IntPtr soundraw = new IntPtr();
            Sound soundnew = null;
        ...
        internal RESULT getNumPlaying( ref int numplaying )
        {
        ...
        internal void setRaw( IntPtr soundgroup )
        {
    ...
    */
    internal class DSP
    {
        ...
        internal RESULT addInput( DSP target, ref DSPConnection connection )
        {
            RESULT result = RESULT.OK;
            IntPtr dspconnectionraw = new IntPtr();
            DSPConnection dspconnectionnew = null;
        ...
        internal RESULT disconnectFrom( DSP target )
        {
            return FMOD_DSP_DisconnectFrom( dspraw, target.getRaw() );
        }
        internal RESULT disconnectAll( bool inputs, bool outputs )
        {
        ...
        internal RESULT getNumInputs( ref int numinputs )
        {
            return FMOD_DSP_GetNumInputs( dspraw, ref numinputs );
        }
        internal RESULT getNumOutputs( ref int numoutputs )
        {
            return FMOD_DSP_GetNumOutputs( dspraw, ref numoutputs );
        }
        internal RESULT getInput( int index, ref DSP input, ref DSPConnection inputconnection )
        {
            RESULT result = RESULT.OK;
        ...
        internal RESULT getOutput( int index, ref DSP output, ref DSPConnection outputconnection )
        {
            RESULT result = RESULT.OK;
            IntPtr dsprawnew = new IntPtr();
            DSP dspnew = null;
        ...
        internal RESULT setActive( bool active )
        {
            return FMOD_DSP_SetActive( dspraw, (active ? 1 : 0) );
        }
        internal RESULT getActive( ref bool active )
        {
            RESULT result;
            int a = 0;
        ...
        internal RESULT setBypass( bool bypass )
        {
            return FMOD_DSP_SetBypass( dspraw, (bypass ? 1 : 0) );
        }
        internal RESULT getBypass( ref bool bypass )
        {
            RESULT result;
            int b = 0;
        ...
        internal RESULT setSpeakerActive( SPEAKER speaker, bool active )
        {
            return FMOD_DSP_SetSpeakerActive( dspraw, speaker, (active ? 1 : 0) );
        }
        internal RESULT getSpeakerActive( SPEAKER speaker, ref bool active )
        {
            RESULT result;
            int a = 0;
        ...
        internal RESULT setParameter( int index, float value )
        {
            return FMOD_DSP_SetParameter( dspraw, index, value );
        }
        internal RESULT getParameter( int index, ref float value, StringBuilder valuestr, int valuestrlen )
        {
            return FMOD_DSP_GetParameter( dspraw, index, ref value, valuestr, valuestrlen );
        }
        internal RESULT getNumParameters( ref int numparams )
        {
            return FMOD_DSP_GetNumParameters( dspraw, ref numparams );
        }
        internal RESULT getParameterInfo( int index, StringBuilder name, StringBuilder label, StringBuilder description, int descriptionlen, ref float min, ref float max )
        {
            return FMOD_DSP_GetParameterInfo( dspraw, index, name, label, description, descriptionlen, ref min, ref max );
        }
        internal RESULT showConfigDialog( IntPtr hwnd, bool show )
        {
            return FMOD_DSP_ShowConfigDialog( dspraw, hwnd, (show ? 1 : 0) );
        }


        internal RESULT getInfo( StringBuilder name, ref uint version, ref int channels, ref int configwidth, ref int configheight )
        {
            return FMOD_DSP_GetInfo( dspraw, name, ref version, ref channels, ref configwidth, ref configheight );
        }
        internal RESULT getType( ref DSP_TYPE type )
        {
        ...
        internal void setRaw( IntPtr dsp )
        {
            dspraw = new IntPtr();
    ...
    */
    ...
    {
        internal RESULT getInput( ref DSP input )
        {
            RESULT result = RESULT.OK;
            IntPtr dspraw = new IntPtr();
            DSP dspnew = null;
        ...
        internal RESULT getOutput( ref DSP output )
        {
            RESULT result = RESULT.OK;
            IntPtr dspraw = new IntPtr();
            DSP dspnew = null;
        ...
        internal RESULT setMix( float volume )
        {
            return FMOD_DSPConnection_SetMix( dspconnectionraw, volume );
        }
        internal RESULT getMix( ref float volume )
        {
            return FMOD_DSPConnection_GetMix( dspconnectionraw, ref volume );
        }
        internal RESULT setLevels( SPEAKER speaker, float[] levels, int numlevels )
        {
            return FMOD_DSPConnection_SetLevels( dspconnectionraw, speaker, levels, numlevels );
        }
        internal RESULT getLevels( SPEAKER speaker, float[] levels, int numlevels )
        {
        ...
        internal void setRaw( IntPtr dspconnection )
        {
    ...
    */
    internal class Geometry
    {
        ...
        internal RESULT addPolygon( float directocclusion, float reverbocclusion, bool doublesided, int numvertices, VECTOR[] vertices, ref int polygonindex )
        {
        ...
        internal RESULT getNumPolygons( ref int numpolygons )
        {
            return FMOD_Geometry_GetNumPolygons( geometryraw, ref numpolygons );
        }
        internal RESULT getMaxPolygons( ref int maxpolygons, ref int maxvertices )
        {
            return FMOD_Geometry_GetMaxPolygons( geometryraw, ref maxpolygons, ref maxvertices );
        }
        internal RESULT getPolygonNumVertices( int index, ref int numvertices )
        {
            return FMOD_Geometry_GetPolygonNumVertices( geometryraw, index, ref numvertices );
        }
        internal RESULT setPolygonVertex( int index, int vertexindex, ref VECTOR vertex )
        {
            return FMOD_Geometry_SetPolygonVertex( geometryraw, index, vertexindex, ref vertex );
        }
        internal RESULT getPolygonVertex( int index, int vertexindex, ref VECTOR vertex )
        {
            return FMOD_Geometry_GetPolygonVertex( geometryraw, index, vertexindex, ref vertex );
        }
        internal RESULT setPolygonAttributes( int index, float directocclusion, float reverbocclusion, bool doublesided )
        {
            return FMOD_Geometry_SetPolygonAttributes( geometryraw, index, directocclusion, reverbocclusion, (doublesided ? 1 : 0) );
        }
        internal RESULT getPolygonAttributes( int index, ref float directocclusion, ref float reverbocclusion, ref bool doublesided )
        {
            RESULT result;
            int ds = 0;
        ...
        internal RESULT setRotation( ref VECTOR forward, ref VECTOR up )
        {
            return FMOD_Geometry_SetRotation( geometryraw, ref forward, ref up );
        }
        internal RESULT getRotation( ref VECTOR forward, ref VECTOR up )
        {
            return FMOD_Geometry_GetRotation( geometryraw, ref forward, ref up );
        }
        internal RESULT setPosition( ref VECTOR position )
        {
            return FMOD_Geometry_SetPosition( geometryraw, ref position );
        }
        internal RESULT getPosition( ref VECTOR position )
        {
            return FMOD_Geometry_GetPosition( geometryraw, ref position );
        }
        internal RESULT setScale( ref VECTOR scale )
        {
            return FMOD_Geometry_SetScale( geometryraw, ref scale );
        }
        internal RESULT getScale( ref VECTOR scale )
        {
            return FMOD_Geometry_GetScale( geometryraw, ref scale );
        }
        internal RESULT save( IntPtr data, ref int datasize )
        {
        ...
        internal void setRaw( IntPtr geometry )
        {
    ...
    */
    internal class Reverb
    {
        ...
        // Reverb manipulation.
        internal RESULT set3DAttributes( ref VECTOR position, float mindistance, float maxdistance )
        {
            return FMOD_Reverb_Set3DAttributes( reverbraw, ref position, mindistance, maxdistance );
        }
        internal RESULT get3DAttributes( ref VECTOR position, ref float mindistance, ref float maxdistance )
        {
            return FMOD_Reverb_Get3DAttributes( reverbraw, ref position, ref mindistance, ref maxdistance );
        }
        internal RESULT setProperties( ref REVERB_PROPERTIES properties )
        {
            return FMOD_Reverb_SetProperties( reverbraw, ref properties );
        }
        internal RESULT getProperties( ref REVERB_PROPERTIES properties )
        {
        ...
        internal void setRaw( IntPtr rev )
        {
