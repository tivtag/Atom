...
namespace Atom.Fmod.Native
{
    ...
    [
        ...
        [REMARKS]
        Every internal FMOD class has a getMemoryInfo function which can be used to get detailed information on what memory resources are associated with the object in question. 
    ...
    */
    ...
    internal struct MEMORY_USAGE_DETAILS
    {
        internal uint other;                          /* [out] Memory not accounted for by other types */
        internal uint stringdata;                     /* [out] String data */
        internal uint system;                         /* [out] System object and various internals */
        internal uint plugins;                        /* [out] Plugin objects and internals */
        internal uint output;                         /* [out] Output module object and internals */
        internal uint channel;                        /* [out] Channel related memory */
        internal uint channelgroup;                   /* [out] ChannelGroup objects and internals */
        internal uint codec;                          /* [out] Codecs allocated for streaming */
        internal uint file;                           /* [out] File buffers and structures */
        internal uint sound;                          /* [out] Sound objects and internals */
        internal uint secondaryram;                   /* [out] Sound data stored in secondary RAM */
        internal uint soundgroup;                     /* [out] SoundGroup objects and internals */
        internal uint streambuffer;                   /* [out] Stream buffer memory */
        internal uint dspconnection;                  /* [out] DSPConnection objects and internals */
        internal uint dsp;                            /* [out] DSP implementation objects */
        internal uint dspcodec;                       /* [out] Realtime file format decoding DSP objects */
        internal uint profile;                        /* [out] Profiler memory footprint. */
        internal uint recordbuffer;                   /* [out] Buffer used to store recorded data from microphone */
        internal uint reverb;                         /* [out] Reverb implementation objects */
        internal uint reverbchannelprops;             /* [out] Reverb channel properties structs */
        internal uint geometry;                       /* [out] Geometry objects and internals */
        internal uint syncpoint;                      /* [out] Sync point memory. */
        internal uint eventsystem;                    /* [out] EventSystem and various internals */
        internal uint musicsystem;                    /* [out] MusicSystem and various internals */
        internal uint fev;                            /* [out] Definition of objects contained in all loaded projects e.g. events, groups, categories */
        internal uint memoryfsb;                      /* [out] Data loaded with registerMemoryFSB */
        internal uint eventproject;                   /* [out] EventProject objects and internals */
        internal uint eventgroupi;                    /* [out] EventGroup objects and internals */
        internal uint soundbankclass;                 /* [out] Objects used to manage wave banks */
        internal uint soundbanklist;                  /* [out] Data used to manage lists of wave bank usage */
        internal uint streaminstance;                 /* [out] Stream objects and internals */
        internal uint sounddefclass;                  /* [out] Sound definition objects */
        internal uint sounddefdefclass;               /* [out] Sound definition static data objects */
        internal uint sounddefpool;                   /* [out] Sound definition pool data */
        internal uint reverbdef;                      /* [out] Reverb definition objects */
        internal uint eventreverb;                    /* [out] Reverb objects */
        internal uint userproperty;                   /* [out] User property objects */
        internal uint eventinstance;                  /* [out] Event instance base objects */
        internal uint eventinstance_complex;          /* [out] Complex event instance objects */
        internal uint eventinstance_simple;           /* [out] Simple event instance objects */
        internal uint eventinstance_layer;            /* [out] Event layer instance objects */
        internal uint eventinstance_sound;            /* [out] Event sound instance objects */
        internal uint eventenvelope;                  /* [out] Event envelope objects */
        internal uint eventenvelopedef;               /* [out] Event envelope definition objects */
        internal uint eventparameter;                 /* [out] Event parameter objects */
        internal uint eventcategory;                  /* [out] Event category objects */
        internal uint eventenvelopepoint;             /* [out] Event envelope point objects */
        internal uint eventinstancepool;              /* [out] Event instance pool memory */
    }
    ...
    [
        ...
        [DESCRIPTION]
        Bitfield used to request specific memory usage information from the getMemoryInfo function of every internal FMOD Ex class.<br>
    ...
    */
    ...
    [
        ...
        [DESCRIPTION]   
        Bitfield used to request specific memory usage information from the getMemoryInfo function of every internal FMOD Event System class.<br>
        Use with the "event_memorybits" parameter of getMemoryInfo to get information on FMOD Event System memory usage.

        [REMARKS]
        Every internal FMOD Event System class has a getMemoryInfo function which can be used to get detailed information on what memory resources are associated with the object in question. 
    ...
    */
    internal enum EVENT_MEMBITS : uint
    {
